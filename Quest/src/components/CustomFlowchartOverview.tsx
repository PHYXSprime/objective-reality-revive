...
export default function CustomFlowchartOverview({
  ...
  // Jump to current node with zoom and smooth animation
  const jumpToCurrentNode = useCallback(() => {
    ...
    if (currentNode && containerRef.current) {
      ...
      // Zoom in to 1.2 scale (120%) to show the node clearly
      const scale = 1.2;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/95">
      <div className="relative w-full h-full">
        ...
        {/* Hint to find current node - clickable to jump, positioned below title on left */}
                    ...
                    {node.isCurrent && (
                      <>
                        ...
                        <rect
                          ...
                          strokeWidth={2}
                        />
                        {/* YOU ARE HERE label above the node */}
                        <g>
                          <rect
