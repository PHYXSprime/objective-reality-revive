...
const translations = {
  ...
  priorDesc: {
    ...
    it: "La tua credenza iniziale prima di vedere le prove (0-100%)",
  ...
  likelihoodDesc: {
    ...
    it: "Probabilità di vedere questa prova SE l'ipotesi è vera (0-100%)",
  ...
  falsePositive: {
    ...
    it: "Tasso di falsi positivi P(E|¬H)",
  ...
  falsePositiveDesc: {
    ...
    it: "Probabilità di vedere questa prova SE l'ipotesi è FALSA (0-100%)",
  ...
  posterior: {
    ...
    it: "Probabilità a posteriori P(H|E)",
  ...
  posteriorDesc: {
    ...
    it: "La tua credenza aggiornata dopo aver considerato le prove",
...
const videoResources = [
  ...
  },
  {
    title: {
      ...
      de: "Das Paradox des medizinischen Tests und die Neugestaltung der Bayes-Regel",
      fr: "Le paradoxe du test médical et la refonte de la règle de Bayes",
      es: "La paradoja de la prueba médica y el rediseño de la regla de Bayes"
    },
    channel: "3Blue1Brown",
...
export default function BayesTheorem() {
  ...
  return (
    <div className="space-y-6">
      ...
      {showGuide && (
        <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/30 text-sm space-y-2">
          ...
          <p className="text-muted-foreground mt-2">
            <em>Example: If you think there's a 50% chance of rain, and you see dark clouds (90% likely if rain, 20% if no rain), 
            your updated belief should be ~82%.</em>
          </p>
        </div>
      )}

      {/* Calculator - wrapped in green box */}
      ...
      {/* Video Resources - now at the bottom */}
