...
export const nodes: FlowchartNode[] = [
  ...
  },
  {
    ...
    options: [
      { label: { en: 'Yes', de: 'Ja', fr: 'Oui', es: 'Sí' }, nextNodeId: 'Collect', style: 'yes' },
      { label: { en: 'No', de: 'Nein', fr: 'Non', es: 'No' }, nextNodeId: 'SeekExpert', style: 'no' }
    ]
  },
  {
    id: 'SeekExpert',
  ...
  },
  {
    ...
    options: [
      { label: { en: 'Yes', de: 'Ja', fr: 'Oui', es: 'Sí' }, nextNodeId: 'Formulate', style: 'yes' },
      { label: { en: 'No', de: 'Nein', fr: 'Non', es: 'No' }, nextNodeId: 'IsSupernatural', style: 'no' }
    ]
  },
  ...
  },
  {
    ...
    options: [
      { label: { en: 'Yes', de: 'Ja', fr: 'Oui', es: 'Sí' }, nextNodeId: 'Design', style: 'yes' },
      { label: { en: 'No', de: 'Nein', fr: 'Non', es: 'No' }, nextNodeId: 'ReformulateHyp', style: 'no' }
    ]
  },
  {
    id: 'ReformulateHyp',
  ...
  // NON-TESTABLE CLASSIFICATION
  {
    ...
    options: [
      { label: { en: 'Yes', de: 'Ja', fr: 'Oui', es: 'Sí' }, nextNodeId: 'Religion', style: 'yes' },
      { label: { en: 'No', de: 'Nein', fr: 'Non', es: 'No' }, nextNodeId: 'IsRigid', style: 'no' }
    ]
  },
  {
    id: 'IsRigid',
    ...
    options: [
      { label: { en: 'Yes', de: 'Ja', fr: 'Oui', es: 'Sí' }, nextNodeId: 'Dogma', style: 'yes' },
      { label: { en: 'No', de: 'Nein', fr: 'Non', es: 'No' }, nextNodeId: 'IsIdeology', style: 'no' }
    ]
  },
  {
    id: 'IsIdeology',
    ...
    options: [
      { label: { en: 'Yes', de: 'Ja', fr: 'Oui', es: 'Sí' }, nextNodeId: 'Ideology', style: 'yes' },
      { label: { en: 'No', de: 'Nein', fr: 'Non', es: 'No' }, nextNodeId: 'IsSecret', style: 'no' }
    ]
  },
  {
    id: 'IsSecret',
    ...
    options: [
      { label: { en: 'Yes', de: 'Ja', fr: 'Oui', es: 'Sí' }, nextNodeId: 'Conspiracy', style: 'yes' },
      { label: { en: 'No', de: 'Nein', fr: 'Non', es: 'No' }, nextNodeId: 'Gossip', style: 'no' }
    ]
  },
  {
    id: 'Religion',
    type: 'category',
    subgraph: 'NT',
    title: { en: 'Religion', de: 'Religion', fr: 'Religion', es: 'Religión' },
    description: {
  ...
  },
  {
    ...
    type: 'category',
    subgraph: 'NT',
    title: { en: 'Dogma', de: 'Dogma', fr: 'Dogme', es: 'Dogma' },
    description: {
  ...
  },
  {
    ...
    type: 'category',
    subgraph: 'NT',
    title: { en: 'Ideology', de: 'Ideologie', fr: 'Idéologie', es: 'Ideología' },
    description: {
  ...
  },
  {
    ...
    type: 'category',
    subgraph: 'NT',
    title: { en: 'Conspiracy', de: 'Verschwörung', fr: 'Conspiration', es: 'Conspiración' },
    description: {
  ...
  },
  {
    ...
    type: 'category',
    subgraph: 'NT',
    title: { en: 'Gossip', de: 'Klatsch', fr: 'Ragots', es: 'Chisme' },
    description: {
  ...
  },
  {
    ...
    tips: {
      en: [
        ...
        'Look for Cochrane reviews in medical topics',
        'Check for publication bias'
      ],
      de: [
        'Meta-Analysen sind stärker als einzelne Studien',
        'Suchen Sie nach Cochrane-Reviews bei medizinischen Themen',
        'Prüfen Sie auf Publikationsbias'
      ],
      fr: [
        'Les méta-analyses sont plus fortes que les études individuelles',
        'Recherchez les revues Cochrane sur les sujets médicaux',
        'Vérifiez le biais de publication'
      ],
      es: [
        'Los meta-análisis son más fuertes que los estudios individuales',
        'Busque revisiones Cochrane en temas médicos',
        'Verifique el sesgo de publicación'
      ]
    },
    nextNodeId: 'Conflicts'
  },
  {
    id: 'Conflicts',
    type: 'decision',
    ...
    title: {
      ...
      de: 'Interessenkonflikte?',
      fr: 'Conflits d\'intérêts?',
      es: '¿Conflictos de interés?'
    },
    description: {
      en: 'Are there potential conflicts of interest that might bias the evidence or its interpretation?',
      de: 'Gibt es potenzielle Interessenkonflikte, die die Beweise verzerren könnten?',
      fr: 'Y a-t-il des conflits d\'intérêts potentiels qui pourraient biaiser les preuves?',
      es: '¿Hay posibles conflictos de interés que puedan sesgar la evidencia?'
    },
    options: [
      { label: { en: 'Yes', de: 'Ja', fr: 'Oui', es: 'Sí' }, nextNodeId: 'AdjustForConflict', style: 'yes' },
      { label: { en: 'No', de: 'Nein', fr: 'Non', es: 'No' }, nextNodeId: 'ConfidenceCheck', style: 'no' }
    ]
  },
  {
    id: 'AdjustForConflict',
    type: 'process',
    subgraph: 'EE',
    title: {
      en: 'Adjust for Conflicts',
      de: 'Konflikte berücksichtigen',
      fr: 'Ajuster pour les conflits',
      es: 'Ajustar por conflictos'
    },
    description: {
      en: 'Discount evidence proportionally to the potential bias. Seek independent sources without the same conflicts.',
      de: 'Bewerten Sie Beweise entsprechend dem potenziellen Bias ab.',
      fr: 'Décomptez les preuves proportionnellement au biais potentiel.',
      es: 'Descuenta la evidencia proporcionalmente al sesgo potencial.'
    },
    nextNodeId: 'ConfidenceCheck'
  },
  {
    id: 'ConfidenceCheck',
    type: 'decision',
    ...
    description: {
      en: 'Based on all evidence evaluated, what is your current confidence level in the hypothesis?',
      de: 'Basierend auf allen bewerteten Beweisen, wie hoch ist Ihr aktuelles Vertrauen?',
      fr: 'Sur la base de toutes les preuves évaluées, quel est votre niveau de confiance actuel?',
      es: 'Basándote en toda la evidencia evaluada, ¿cuál es tu nivel de confianza actual?'
    },
    specialContent: 'confidence',
    options: [
      { label: { en: '≥80% High', de: '≥80% Hoch', fr: '≥80% Élevé', es: '≥80% Alto' }, nextNodeId: 'ProceedHigh', style: 'yes' },
      { label: { en: '40-79% Medium', de: '40-79% Mittel', fr: '40-79% Moyen', es: '40-79% Medio' }, nextNodeId: 'ProceedMedium', style: 'neutral' },
      { label: { en: '<40% Low', de: '<40% Niedrig', fr: '<40% Faible', es: '<40% Bajo' }, nextNodeId: 'Reevaluate', style: 'no' }
    ]
  },
  {
    id: 'ProceedHigh',
    ...
    description: {
      ...
      de: 'Ihre Beweise unterstützen die Hypothese stark.',
      fr: 'Vos preuves soutiennent fortement l\'hypothèse.',
      es: 'Tu evidencia apoya fuertemente la hipótesis.'
    },
    tips: {
      en: [
      ...
      de: [
        ...
        'Überprüfen Sie dennoch auf Bestätigungsfehler'
      ],
      fr: [
      ...
      es: [
        ...
        'Aún verifica el sesgo de confirmación antes de concluir'
      ]
    },
    nextNodeId: 'Conclude'
  },
  {
    ...
    description: {
      ...
      de: 'Die Beweise sind gemischt. Erwägen Sie, mehr Daten zu sammeln.',
      fr: 'Les preuves sont mitigées. Envisagez de recueillir plus de données.',
      es: 'La evidencia es mixta. Considera recopilar más datos.'
    },
    tips: {
      en: [
  ...
  },
  {
    ...
    description: {
      ...
      de: 'Das Vertrauen ist zu niedrig.',
      fr: 'La confiance est trop faible.',
      es: 'La confianza es demasiado baja.'
    },
    tips: {
      en: [
        'Low confidence (<40%) is valuable information',
        'Ask: Is the hypothesis testable?',
        'Consider suspending judgment rather than forcing a conclusion'
      ],
      de: [
        'Niedriges Vertrauen (<40%) ist wertvolle Information',
        'Fragen Sie: Ist die Hypothese testbar?',
        'Erwägen Sie, das Urteil auszusetzen'
      ],
      fr: [
        'Faible confiance (<40%) est une information précieuse',
        'Demandez: L\'hypothèse est-elle testable?',
        'Envisagez de suspendre le jugement'
      ],
      es: [
        'Baja confianza (<40%) es información valiosa',
        'Pregunta: ¿Es la hipótesis comprobable?',
        'Considera suspender el juicio'
      ]
    },
  ...
  },
  {
    ...
    tips: {
      ...
      es: [
        ...
        'Pregunta: "¿Qué creería si no tuviera interés en el resultado?"'
      ]
    },
    options: [
      { label: { en: 'Yes', de: 'Ja', fr: 'Oui', es: 'Sí' }, nextNodeId: 'AcknowledgeBias', style: 'yes' },
      { label: { en: 'No', de: 'Nein', fr: 'Non', es: 'No' }, nextNodeId: 'Steelman', style: 'no' }
    ]
  },
  {
    id: 'AcknowledgeBias',
  ...
  },
  {
    ...
    tips: {
      en: [
        ...
        'False dichotomy: More than two options may exist',
      ...
      de: [
        ...
        'Falsches Dilemma: Es können mehr als zwei Optionen existieren',
        'Strohmann: Falsche Darstellung gegensätzlicher Ansichten'
      ],
      fr: [
        'Ad hominem: Attaquer la personne, pas l\'argument',
        'Appel à l\'autorité: Opinion d\'expert ≠ preuve',
        'Faux dilemme: Plus de deux options peuvent exister',
        'Homme de paille: Déformer les points de vue opposés'
      ],
      es: [
        'Ad hominem: Atacar a la persona, no al argumento',
        'Apelación a la autoridad: Opinión experta ≠ prueba',
        'Falsa dicotomía: Pueden existir más de dos opciones',
        'Hombre de paja: Tergiversar puntos de vista opuestos'
      ]
    },
    nextNodeId: 'Verify'
  },
  {
    ...
    title: {
      ...
      de: 'Unabhängig verifizieren',
      fr: 'Vérifier indépendamment',
      es: 'Verificar independientemente'
    },
    description: {
      en: 'Try to replicate or verify your findings through independent means.',
      de: 'Versuchen Sie, Ihre Ergebnisse unabhängig zu replizieren oder zu verifizieren.',
      fr: 'Essayez de répliquer ou de vérifier vos résultats de manière indépendante.',
      es: 'Intenta replicar o verificar tus hallazgos de forma independiente.'
    },
  ...
  },
  {
    ...
    description: {
      en: 'Submit your conclusions for review by others who can critically evaluate them.',
      de: 'Reichen Sie Ihre Schlussfolgerungen zur Überprüfung durch andere ein.',
      fr: 'Soumettez vos conclusions à l\'examen par d\'autres.',
  ...
  },
  {
    ...
    description: {
      ...
      de: 'Was war das Ergebnis des Peer-Reviews?',
      fr: 'Quel a été le résultat de la revue par les pairs?',
      es: '¿Cuál fue el resultado de la revisión por pares?'
    },
    options: [
      { label: { en: 'Confirmed', de: 'Bestätigt', fr: 'Confirmé', es: 'Confirmado' }, nextNodeId: 'HighConfTrue', style: 'yes' },
      { label: { en: 'Needs Revision', de: 'Überarbeitung nötig', fr: 'Révision nécessaire', es: 'Necesita revisión' }, nextNodeId: 'AI_Reevaluate', style: 'neutral' },
      { label: { en: 'Refuted', de: 'Widerlegt', fr: 'Réfuté', es: 'Refutado' }, nextNodeId: 'ErrorDetected', style: 'no' }
    ]
  },
  {
    id: 'AI_Reevaluate',
  ...
  },
  {
    ...
    description: {
      ...
      fr: 'Réfuté. Cette affirmation a été prouvée fausse.',
      es: 'Refutado. Esta afirmación ha sido demostrada falsa.'
    },
